...
pub(crate) fn resources() -> Value {
    json!([
        ...
        },
        {
            ...
            "description": "Read-only operational health checks for the Trail workspace.",
            "mimeType": "application/json"
        },
        {
            "uri": RESOURCE_LANES,
        ...
        },
        {
            ...
            "description": "The local Trail HTTP API OpenAPI 3.1 document.",
            "mimeType": "application/json"
        },
        {
        ...
        },
        {
            ...
            "name": "user-guide",
            "title": "Trail User Guide",
            "description": "End-user guide for common Trail workflows.",
            "mimeType": "text/markdown"
        },
        {
            "uri": RESOURCE_LANE_WORKFLOWS,
            "name": "lane-workflows",
            "title": "Trail Lane Workflows",
        ...
        },
        {
            ...
            "name": "cli-reference",
            "title": "Trail CLI Reference",
            "description": "Command reference for the Trail CLI and local API surfaces.",
            "mimeType": "text/markdown"
        }
    ])
}
