...
- [x] 7.8 Add divergent-producer, malicious-plan, undeclared-write, denied-network, child-process, secret-leak, unsafe-output, revoked-package, unsupported-sandbox, and attestation-tamper tests
...
- [x] 9.2 Implement exact highest-mutual-version negotiation and deterministic v1/v2 conversions that cannot obtain v3 semantics from absent fields
...
- [x] 11.3 Add aligned HTTP routes/OpenAPI schemas and MCP tools/resources/risk annotations backed by the same library operations and reports
