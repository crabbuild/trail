...
- `kind`: operation type such as `Init`, `ManualRecord`, `WatchRecord`, `LanePatch`, `LaneRecord`, `LaneMerge`, `Merge`, or `GitExport`.
...
- `session_id`: optional durable lane session link.
