...
- Daemon args and auth: `crates/trail/src/cli/command/maintenance_args.rs`, `crates/trail/src/cli/command/handler/maintenance.rs`
- Daemon CLI routing: `crates/trail/src/cli/command/handler/daemon_rpc.rs`
