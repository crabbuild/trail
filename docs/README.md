...
- [Native agent hooks and ACP integration design](design/native-agent-hooks-and-acp.md)
...
- [Universal lane environments](design/universal-lane-environments.md)
- [Environment adapter and specification contract](design/environment-adapter-contract.md)
- [Environment adapter Rust SDK](../trail-environment-adapter-sdk/README.md)
