...
pub(super) fn push_active_leases_check(db: &CrabDb, checks: &mut Vec<DoctorCheck>) {
...
pub(super) fn push_merge_queue_check(db: &CrabDb, checks: &mut Vec<DoctorCheck>) {
...
pub(super) fn push_conflicts_check(db: &CrabDb, checks: &mut Vec<DoctorCheck>) {
