...
pub(super) fn push_write_lock_check(db: &CrabDb, checks: &mut Vec<DoctorCheck>) {
...
pub(super) fn push_daemon_token_check(db: &CrabDb, checks: &mut Vec<DoctorCheck>) {
...
pub(super) fn push_fsck_check(db: &CrabDb, checks: &mut Vec<DoctorCheck>) {
    match db.fsck() {
