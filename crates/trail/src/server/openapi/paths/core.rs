...
pub(super) fn core_paths() -> Value {
    json!({
        ...
        "/v1/config": {
            "get": openapi_operation("configList", "List config", "List typed Trail workspace config entries.", vec![], None, true),
            "post": openapi_operation("configSet", "Set config", "Set one Trail workspace config entry.", vec![], Some("ConfigSetRequest"), true)
        },
        "/v1/config/{key}": {
        ...
        "/v1/ignore": {
            "get": openapi_operation("ignoreList", "List ignore rules", "List workspace .trailignore patterns.", vec![], None, true)
        },
        "/v1/ignore/patterns": {
            "post": openapi_operation("ignoreAdd", "Add ignore rule", "Add a workspace .trailignore pattern.", vec![], Some("IgnorePatternRequest"), true),
            "delete": openapi_operation("ignoreRemove", "Remove ignore rule", "Remove a workspace .trailignore pattern.", vec![], Some("IgnorePatternRequest"), true)
        },
        "/v1/ignore/check": {
